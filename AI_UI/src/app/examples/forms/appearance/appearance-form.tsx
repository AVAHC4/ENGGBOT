...
const appearanceFormSchema = z.object({
  ...
  font: z.enum(["inter", "manrope", "system", "sohne", "serif", "playfair", "outfit", "fira-code", "plus-jakarta", "lora"], {
              ...
              >
                <FormItem className="w-full">
                  <FormLabel className="w-full cursor-pointer [&:has([data-state=checked])>div]:border-primary">
                    ...
                    <span className="block w-full p-2 text-center font-normal cursor-pointer">
                      Light
                    </span>
                  </FormLabel>
                </FormItem>
