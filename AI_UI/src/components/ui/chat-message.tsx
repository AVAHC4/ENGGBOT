    ...
    <div className={cn(
      ...
      <div className="message-wrapper">
        <div className={cn(
          ...
          {isUser ? <User size={20} /> : <ChatGPTLogo />}
        </div>
